    ...
    for col in df_bootstrap_slc.columns:
        ...
        keras_fit_options_1st = { "epochs": 100,
                            ...
                            "callbacks": [keras.callbacks.EarlyStopping(patience=3, restore_best_weights=True), 
                                        keras.callbacks.CSVLogger('../model/train_history_{}_1st.csv'.format(col), separator=",", append=False)]}
        keras_fit_options_2nd = { "epochs": 100,
                            "validation_split": 0.2,
                            "batch_size": 128,
                            'verbose':1, 
                            "callbacks": [keras.callbacks.EarlyStopping(patience=3, restore_best_weights=True), 
                                        keras.callbacks.CSVLogger('../model/train_history_{}_2nd.csv'.format(col), separator=",", append=False)]}
